...
- la página **171** tiene sus **24 candidatos canónicos reconciliados**: 23 `article` y 1 `continuation`, sin candidatos estructuralmente `unresolved`; L-007 queda `merged_articles`, se documentan 8 falsos negativos seleccionados `000576`–`000583`, R-001 es `continuation/from_previous_column`, permanecen 16 fronteras `pending_promotion` y el censo visible sigue no exhaustivo; p.172 tiene 55 candidatos y `000584` (`Relampago`) es un comienzo superior sin frontera propia;
- la página **172** tiene sus **55 candidatos canónicos reconciliados**: 55 `article`, sin continuaciones ni candidatos estructuralmente `unresolved`; `000584` (`Relampago`) queda como falso negativo superior, R-028 queda `merged_articles`, los 15 artículos seleccionados `ALC1737-art-000584`–`000598` quedan enlazados a evidencia estructural, permanecen 41 fronteras `pending_promotion` y el censo visible sigue no exhaustivo; p.173 tiene 42 candidatos y `000599` (`Rueda`) es un comienzo superior sin frontera propia antes de L-001 (`Sabio`);
- la página **173** tiene sus **42 candidatos canónicos reconciliados**: 40 `article` y 2 `continuation`, sin candidatos estructuralmente `unresolved`; se documentan 4 falsos negativos seleccionados (`000599` Rueda, `000600` Saber generalmente, `000605` Sahumar, `000607` Salitral), L-010/L-011/R-015 quedan `merged_articles`, R-018 `undersegmented`, permanecen 29 fronteras `pending_promotion` y el censo visible sigue no exhaustivo; p.174 tiene 48 candidatos y `000614` (`Si, adv. para afirmar`) es un comienzo superior sin frontera propia antes de L-001 (`Si, conj.`);
- las páginas **174–177** ya poseen representación lexicográfica estructurada, pero su reconciliación exhaustiva página por página sigue pendiente;
