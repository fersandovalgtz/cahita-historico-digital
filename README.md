...
La reconciliación geométrica de candidatos del Vocabulario está completa en **pp.133–177 (45/45 páginas)**. El siguiente frente científico vuelve a **p.145** para completar, página por página, el **censo exhaustivo de inicios visibles** y la **promoción/enlace** de fronteras todavía sustentadas sólo por geometría/OCR. Ese trabajo debe conservar la política vigente: no promocionar lecturas OCR-only sin evidencia suficiente, mantener `humanVerified=false`, localizar explícitamente los candidatos `unresolved` y no calcular precisión/recall/F1 en páginas cuyo denominador visible siga sin ser exhaustivo.
