...
- la capa curatorial alcanza **910 artículos históricos estructurados**;
...
- las páginas digitales **133–140** tienen ya ciclo cerrado de candidato → censo visible → promoción → QA;
- en ese tramo se reconciliaron **335/335 candidatos canónicos**: 316 `article` y 19 `continuation`;
- el censo facsimilar registra **357 inicios históricos visibles**: TP316 / FP19 / FN41;
...
- `COVERAGE.md` registra actualmente **910 artículos** y reconciliación cerrada hasta p.140;
...
- escalar la reconciliación exhaustiva desde p.141 hasta p.177;
