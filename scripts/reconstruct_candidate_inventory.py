...
def main() -> None:
    ...
    # Temporary diagnostic for the active p173 direct-facsimile closure.
    for obj in parsed_rows:
        if obj.get("sourcePageDigital") == 173:
            print("P173CAND " + json.dumps(obj, ensure_ascii=False, separators=(",", ":")))
