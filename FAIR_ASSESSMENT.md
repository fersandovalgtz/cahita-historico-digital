...
- DOI: **pendiente de depósito archivístico**
...
| Identificador persistente global | DOI aún no asignado | Pendiente |
| Descubrimiento en repositorios académicos | GitHub Release pública; Zenodo pendiente | Parcial |
...
| Criterio | Evidencia | Estado |
|---|---|---|
| Acceso por protocolo estándar | HTTPS/Git/GitHub Release | Fuerte |
...
| Persistencia archivística independiente | depósito/DOI pendiente | Pendiente |
...
| CLDF | evaluado y diferido como derivado analítico post-v1 | Deliberadamente diferido |

## Reusable — Reutilizable

| Criterio | Evidencia | Estado |
|---|---|---|
| Licencia explícita | MIT para código; CC BY 4.0 para datos/editorial propio | Fuerte |
...
| Citación | `CITATION.cff`, ORCID, versión y release | Fuerte |
...
| Preservación | GitHub Release atestada; DOI/archivo externo pendiente | Parcial |
...
1. **Asignar DOI real mediante depósito archivístico** y sincronizarlo después con CFF, CodeMeta y JSON-LD sin mover el tag `v1.0.0`.
2. **Consolidar preservación independiente** —por ejemplo Zenodo y, cuando corresponda, Software Heritage— para separar disponibilidad en GitHub de preservación a largo plazo.
3. **Ejecutar una evaluación FAIR externa** una vez que exista DOI y conservar su resultado público/versionado.
4. **Mantener explícita la semántica histórica**: no obtener una aparente interoperabilidad asignando un código moderno único o equivalencias modernas que la fuente no sustenta.
5. **Ampliar revisión filológica trazable** de las 22 incertidumbres cuando exista acceso a evidencia admisible.
